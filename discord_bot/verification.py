...
discord_id = "222183992940560384"
verified_name = "Onecentwise"
...
def verify_account(discord_id,verified_name):
    ...
    if id_found == False:
        return("User not found, double check their discord ID, or verify that the person has signed in on the website and setup their account first!")
